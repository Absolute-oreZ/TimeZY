<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
	...
	<body class="w-full flex flex-1 items-center justify-center">
		<div class="flex flex-1">
			<div class="md:flex hidden md:flex-col p-8 w-1/2 m-2 items-center justify-center">
				...
				<div class="text-slate-800 text-center py-4 px-6 font-montserrat font-bold text-3xl">
					<span class="text-7xl font-extrabold">"</span>Embracing Excellence:
					Where Each New Team Member Raises Our Standards!
				</div>
			</div>
			<div class="p-8 m-2 self-center rounded shadow-md h-full md:w-1/2 w-full items-center justify-center">
				<h1 class="text-2xl font-bold mb-6 text-center">Edit User</h1>
				<div id="registerError" class="text-red-500 mb-4">
					<% String editingError=(String) request.getAttribute("editingError"); if (editingError !=null) {
						out.print(editingError); } %>
				</div>
				<form action="/admin/user/edit/${user.userId}" method="post" class="space-y-4">
					<div>
